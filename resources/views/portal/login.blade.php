...
<head>
    <meta charset="utf-8">
    <title>Metro Health Services - Portal Login</title>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 col-lg-7">
                    <img src="{{ asset('portal/vendors/images/login-page-img.png') }}" alt="">
                </div>
                <div class="col-md-6 col-lg-5">
                    <div class="login-box bg-white box-shadow border-radius-10">
                        <div class="login-title">
                            <h2 class="text-center text-primary" style="text-shadow: 10px;">Login To Portal</h2>
                        </div>
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="input-group mb-0">
                                        <a class="btn btn-outline-primary btn-lg btn-block " href="/">Back to Website</a>
                                    </div>
                                </div>
                            </div>
                        </form>
