                    ...
                    <tbody>
                        <tr>
                            <td class="table-plus">
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <!-- <img src="{{ asset('portal/vendors/images/photo4.jpg') }}" class="border-radius-100 shadow" width="40" height="40" alt=""> -->
                                    </div>
                                    <div class="txt">
                        ...
                        <tr>
                            <td class="table-plus">
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <!-- <img src="{{ asset('portal/vendors/images/photo5.jpg') }}" class="border-radius-100 shadow" width="40" height="40" alt=""> -->
                                    </div>
                                    <div class="txt">
                        ...
                        <tr>
                            <td class="table-plus">
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <!-- <img src="{{ asset('portal/vendors/images/photo6.jpg') }}" class="border-radius-100 shadow" width="40" height="40" alt=""> -->
                                    </div>
                                    <div class="txt">
                        ...
                        <tr>
                            <td class="table-plus">
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <!-- <img src="{{ asset('portal/vendors/images/photo9.jpg') }}" class="border-radius-100 shadow" width="40" height="40" alt=""> -->
                                    </div>
                                    <div class="txt">
                        ...
                        <tr>
                            <td class="table-plus">
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <!-- <img src="{{ asset('portal/vendors/images/photo1.jpg') }}" class="border-radius-100 shadow" width="40" height="40" alt=""> -->
                                    </div>
                                    <div class="txt">
                        ...
                        <tr>
                            <td class="table-plus">
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <!-- <img src="{{ asset('portal/vendors/images/photo2.jpg') }}" class="border-radius-100 shadow" width="40" height="40" alt=""> -->
                                    </div>
                                    <div class="txt">
                        ...
                        <tr>
                            <td class="table-plus">
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <!-- <img src="{{ asset('portal/vendors/images/photo8.jpg') }}" class="border-radius-100 shadow" width="40" height="40" alt=""> -->
                                    </div>
                                    <div class="txt">
            ...
            <div class="row">
                <div class="col-md-4 mb-20">
                    <a href="#" class="card-box d-block mx-auto pd-20 text-secondary">
                        <div class="img pb-30">
                            <img src="{{ asset('portal/vendors/images/medicine-bro.svg') }}" alt="">
                        </div>
                        <div class="content">
                ...
                <div class="col-md-4 mb-20">
                    <a href="#" class="card-box d-block mx-auto pd-20 text-secondary">
                        <div class="img pb-30">
                            <img src="{{ asset('portal/vendors/images/remedy-amico.svg') }}" alt="">
                        </div>
                        <div class="content">
                ...
                <div class="col-md-4 mb-20">
                    <a href="#" class="card-box d-block mx-auto pd-20 text-secondary">
                        <div class="img pb-30">
                            <img src="{{ asset('portal/vendors/images/paper-map-cuate.svg') }}" alt="">
                        </div>
                        <div class="content">
