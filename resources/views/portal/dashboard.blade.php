        ...
        <div class="xs-pd-20-10 pd-ltr-20">
            ...
            <div class="row pb-10">
                ...
                <div class="col-md-4 mb-20">
                    <div class="card-box min-height-200px pd-20 mb-20" data-bgcolor="#002d72">
                        ...
                        <div class="d-flex justify-content-between align-items-end">
                            <div class="text-white">
                                <div class="font-14">SMS Sent</div>
                    ...
                    <div class="card-box min-height-200px pd-20" data-bgcolor="#265ed7">
                        ...
                        <div class="d-flex justify-content-between align-items-end">
                            <div class="text-white">
                                <div class="font-14">Contacts</div>
                                <div class="font-24 weight-500">{{ $contacts ?? 0 }}</div>
                            </div>
                            <div class="max-width-150">
                                ...
                                <li class="d-flex align-items-center justify-content-between">
                                    <div class="name-avatar d-flex align-items-center pr-2">
                                        ...
                                        <div class="txt">
                                            ...
                                            <div class="font-14 weight-600">{{ $user->firstname }} {{ $user->othername }}</div>
                                            <div class="font-12 weight-500" data-color="#b2b1b6">{{ $user->status }}</div>
                                        </div>
                                    </div>
