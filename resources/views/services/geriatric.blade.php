        ...
        <div class="container-fluid bg-primary py-5 bg-header page-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Geriatric Care / Elderly Care</h1>
            ...
            <div class="row g-5">
                <div class="col-lg-8">
                    ...
                    <div class="mb-5">
                        ...
                        <h1 class="mb-4 metro-main-text">Geriatric Care / Elderly Care</h1>
                        <p>
                            Our department have highly experienced specialists in Elderly care. These specialists provide the best medical response to your condition.  
                        </p>
                        <p>
                            Our specialists work together with the general laboratory service to 
						    confirm a diagnosis before appropriate management is given. Book an appointment with our specialist today and feel the touch.
                        </p>
                ...
                <div class="col-lg-4">
                   ...
                   <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                        ...
                        <div class="link-animated d-flex flex-column justify-content-start">
                            ...
                            <a class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2 gold-text" href="/serviecs/surgery"><i class="bi bi-arrow-right me-2"></i>General Surgery</a>
