                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <div class="notification-list mx-h-350 customscroll">
                            <ul>
                                <li>
                                    <a href="#">
                                        <img src="{{ asset('portal/vendors/images/img.jpg') }}" alt="">
                                        <h3>John Doe</h3>
                                ...
                                <li>
                                    <a href="#">
                                        <img src="{{ asset('portal/vendors/images/photo1.jpg') }}" alt="">
                                        <h3>Lea R. Frith</h3>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed...</p>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img src="{{ asset('portal/vendors/images/photo2.jpg') }}" alt="">
                                ...
                                <li>
                                    <a href="#">
                                        <img src="{{ asset('portal/vendors/images/photo3.jpg') }}" alt="">
                                        <h3>John Doe</h3>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed...</p>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img src="{{ asset('portal/vendors/images/photo4.jpg') }}" alt="">
