            ...
            <div class="row g-5">
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <div class="blog-item bg-light rounded overflow-hidden">
                        ...
                        <div class="p-4">
                            <h4 class="mb-3"></h4>
                            <p>Our department has experienced specialists in general medicine. 
                            We provide the best medical response to your condition. </p>
                            <a class="text-uppercase metro-main-text gold-text" href="/services/general">Read More <i class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
                    <div class="blog-item bg-light rounded overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <a class="text-uppercase metro-main-text gold-text" href="/services/obstetrics">Read More <i class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                  ...
                  <div class="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
                    <div class="blog-item bg-light rounded overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <a class="text-uppercase metro-main-text gold-text" href="/services/eye">Read More <i class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.9s">
                    <div class="blog-item bg-light rounded overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <a class="text-uppercase metro-main-text gold-text"  href="/services/surgery">Read More <i class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.9s">
                    <div class="blog-item bg-light rounded overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <h4 class="mb-3"></h4>
                            <p>Metro Health Services' pharmacy aids in providing better healthcare through the provision
                               of excellent and prompt pharmaceutical services.</p>
                            <a class="text-uppercase metro-main-text gold-text" href="/services/pharmacy">Read More <i class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.9s">
                    <div class="blog-item bg-light rounded overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <a class="text-uppercase metro-main-text gold-text" href="/services/laboratory">Read More <i class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
                    <div class="blog-item bg-light rounded overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <a class="text-uppercase metro-main-text gold-text" href="/services/ultrasound">Read More <i class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
